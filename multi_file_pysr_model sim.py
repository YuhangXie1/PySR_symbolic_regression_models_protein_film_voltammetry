...
def sim_current(time_data, voltage, dv_dt, A, w, p, c, A_val, p_val):
    current = 8*dv_dt*voltage**2 + 7*dv_dt*voltage**2 + 6*voltage + 5*dv_dt + 10
    return current

### main ###
output_filepath = rf"results/20250618-multi-fit-workflow-sim-test/test-1"
...
for Hz in files_freq:
    ...
    current = sim_current(time_data, voltage, dv_dt, A, w, p, c, A_val, p_val)
