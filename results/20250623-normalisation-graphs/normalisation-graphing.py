...
output_filepath = rf"results/20250623-normalisation-graphs/"
Path(output_filepath).mkdir(parents=True, exist_ok=True)

title = f"All-files-normalised-Aval-time-shift-dvdt"
...
for Hz in files_freq:
    ...
    dv_dt = dv_dt_lambda(time_data)/w
...
axs.legend()
fig.tight_layout()
plt.savefig(os.path.join(output_filepath, f"{title}.png"))